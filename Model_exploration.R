...
#### Correlations ####
round(cor(CleanData[,c(16:21)], use = "complete.obs"), digits = 3)
...
lm_simple <- function(partij){
  lm(CleanData[,partij] ~ CleanData$stedelijkheidsindex.x + CleanData$Percentage.highly.educated + CleanData$Average.income.in..1000  + CleanData$Non_west_perc, na.action=na.omit)
}
