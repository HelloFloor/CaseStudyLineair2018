...
**Electoral data**  
For the electoral data 

In this chapter the data is summarized and explained how the data is collected. The percentage of votes per party per municipality was found on the official data repository of the dutch government.^[https://data.overheid.nl/data/dataset/verkiezingsuitslag-tweede-kamer-2017] The demographics; *amount of non-west residents per municipality*, *the urban index of a municipality* and *the standardized income per municipality*, were found on the CBS site. This is the Dutch central office of statistics.    
